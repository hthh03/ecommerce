            ...
            <div className="border p-6 rounded-md shadow-sm">
              ...
              {activeTab === "password" && (
                <form onSubmit={handleChangePassword} className="flex flex-col gap-4">
                  ...
                  <button 
                    type="submit"
                    className="bg-black text-white font-medium px-6 py-3 mt-4 rounded-md hover:bg-gray-800 transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed"
