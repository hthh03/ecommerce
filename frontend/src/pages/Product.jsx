    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
        ...
        <div className='flex-1'>
          ...
          {/* SIZE SELECTION SECTION - THIS IS WHERE SIZE SELECTION HAPPENS */}
          <div className='flex flex-col gap-4 my-8'>
            <p>Select Size </p>
            <div className='flex gap-2'>
              {/* Add safety check for productData.sizes */}
          ...
          <div className='text-sm text-gray-500 mt-5 flex flex-col gap-1'>
            ...
            <p>Cash on delivery is available on this product.</p> {/* Fixed typo: avaiable -> available */}
            <p>Easy return and exchange policy within 7 days.</p> {/* Fixed typo: enchange -> exchange */}
          </div>
        </div>
      </div>
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
          ...
          <p> E-commerce website typically display products or services along with detailed description ....</p> {/* Fixed typo: tyically -> typically */}
        </div>
      </div>
